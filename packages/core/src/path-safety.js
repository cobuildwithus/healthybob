...
export function normalizeVaultRoot(vaultRoot) {
...
export function normalizeRelativeVaultPath(relativePath) {
...
export function formatVaultRelativePath(vaultRoot, absolutePath) {
  const absoluteRoot = normalizeVaultRoot(vaultRoot)
  const candidate = path.resolve(absolutePath)
...
export function basenameFromFilePath(filePath) {
...
export function sanitizeFileName(fileName, fallback = 'artifact') {
